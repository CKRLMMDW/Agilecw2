...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2019 at 02:07 PM
...
(222, 'AI CW1', 444, '2019-12-27', 50, '2020-01-02', 0),
(223, 'AI CW2', 445, '2019-12-23', 25, '2020-01-31', 0),
(224, 'HCI CW2', 444, '2019-12-18', 50, '2020-01-31', 0),
(230, 'Accounting CW1', 446, '2020-01-02', 50, '2020-01-01', 0),
(231, 'Accounting CW2', 446, '2020-01-01', 50, '2019-12-26', 0),
(255, 'Psychology CW1', 447, '2019-12-18', 50, '2019-12-26', 0),
(256, 'Object Oriented Programming CW 1', 448, '2019-12-20', 50, '2019-12-25', 0);
...
(111, 222, 555, 99, 55, 'Could do better'),
...
--
ALTER TABLE `cw`
  MODIFY `cwid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=257;

--
-- AUTO_INCREMENT for table `modules`
--
ALTER TABLE `modules`
  MODIFY `modid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=449;
